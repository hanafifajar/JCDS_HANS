...
def input_harga(x):
    while True:
        user_input = input(x)
        if user_input.isdigit() and len(user_input) >=7 and len(user_input) <=8:
            return int(user_input)
        else:
            print("Input harus berupa angka dan tidak kurang dari 1jt, kurang dari 100jt. Silakan coba lagi.")
